...
public class Professor extends Usuario {// Classe filha de usuario
    public Professor(String nome, int maxLivros) {// Chama o construtor da classe pai com dois parâmetros (nome e
                                                  // cadastro)
        ...
        super(nome, 3); // super, chama o construtor de Usuario que espera um 'nome' e 'cadastro'
